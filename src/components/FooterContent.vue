...
<template>
  <footer class="flex flex-col gap-10 p-7 md:p-14 bg-x-black overflow-hidden">
    <div class="w-full h-auto flex flex-col md:flex-row items-center justify-between gap-4">
